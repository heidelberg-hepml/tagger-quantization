...
class MaskedBatchNorm1d(nn.BatchNorm1d):
    ...
    def forward(self, inp, mask):
        ...
        assert (
            len(mask.shape) == 3
        ), f"Expected 3 dimensions in mask, instead got {len(mask.shape)} and shape {mask.shape}"
...
class MaskedBatchNorm2d(nn.BatchNorm2d):
    ...
    def forward(self, inp, mask):
        ...
        assert (
            len(mask.shape) == 4
        ), f"Expected 4 dimensions in mask, instead got {len(mask.shape)} and shape {mask.shape}"
...
class MaskedBatchNorm3d(nn.BatchNorm3d):
    ...
    def forward(self, inp, mask):
        ...
        assert (
            len(mask.shape) == 5
        ), f"Expected 5 dimensions in mask, instead got {len(mask.shape)} and shape {mask.shape}"
